...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String notificationTournamentRequestReceived(String name, String tournamentName) {
    String _temp0 = intl.Intl.selectLogic(
      tournamentName,
      {
        'null': '<b>$name</b> envió una solicitud de inscripción al torneo.',
        'other': '<b>$name</b> envió una solicitud de inscripción al torneo <b>$tournamentName</b>.',
      },
    );
    return '$_temp0';
  }
  ...
  String notificationTeamRequestReceived(String name, String teamName) {
    String _temp0 = intl.Intl.selectLogic(
      teamName,
      {
        'null': '<b>$name</b> envió una solicitud para unirse al equipo.',
        'other': '<b>$name</b> envió una solicitud para unirse al equipo <b>$teamName</b>.',
      },
    );
    return '$_temp0';
  }
  ...
  String notificationTeamRequestAccepted(String name, String teamName) {
    String _temp0 = intl.Intl.selectLogic(
      teamName,
      {
        'null': '<b>$name</b> aceptó tu solicitud para unirte al equipo.',
        'other': '<b>$name</b> aceptó tu solicitud para unirte al equipo <b>$teamName</b>.',
      },
    );
    return '$_temp0';
  }
  ...
  String notificationTournamentRequestAccepted(String name, String tournamentName) {
    String _temp0 = intl.Intl.selectLogic(
      tournamentName,
      {
        'null': '<b>$name</b> aceptó tu solicitud de inscripción al torneo.',
        'other': '<b>$name</b> aceptó tu solicitud de inscripción al torneo <b>$tournamentName</b>.',
      },
    );
    return '$_temp0';
  }
  ...
  @override
  String get tournamentNoParticipantsLabelAdmin => 'No hay participantes registrados';
  ...
  @override
  String get tournamentStartDatePassed => 'El torneo ya comenzó, no puedes inscribirte';
  ...
  @override
  String get teamPendingRequests => 'Solicitudes Pendientes';

  @override
  String get teamRequestSingular => 'solicitud';

  @override
  String get teamRequestPlural => 'solicitudes';

  @override
  String get teamAcceptRequest => 'Aceptar';

  @override
  String get teamDeclineRequest => 'Rechazar';

  @override
  String get teamAcceptRequestTitle => 'Aceptar Solicitud';

  @override
  String teamAcceptRequestMessage(String userName) {
    return '¿Estás seguro de que deseas aceptar la solicitud de $userName?';
  }

  @override
  String get teamDeclineRequestTitle => 'Rechazar Solicitud';

  @override
  String teamDeclineRequestMessage(String userName) {
    return '¿Estás seguro de que deseas rechazar la solicitud de $userName?';
  }

  @override
  String get teamRequestAcceptedSuccess => 'Solicitud aceptada exitosamente';

  @override
  String get teamErrorAcceptingRequest => 'Error al aceptar la solicitud';

  @override
  String get teamRequestDeclinedSuccess => 'Solicitud rechazada exitosamente';

  @override
  String get teamErrorDecliningRequest => 'Error al rechazar la solicitud';

  @override
  String get teamNoPendingRequests => 'No hay solicitudes pendientes';

  @override
  String get teamTabInfo => 'Información';

  @override
  String get teamTabRequests => 'Solicitudes';
